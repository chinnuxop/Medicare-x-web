...
//to fetch the services from the server
  ...
  //gives output with date and time like DD-MM-YYYY with HH:MM AM
...
//to edit any service
  ...
  //formate the slots for backend ex-DD-MM_YYYY with HH:MM  am/pm
  ...
  //convert slot obj to time timesstamp in local timezone
