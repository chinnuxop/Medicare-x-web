...
import { User, XCircle, Eye, EyeClosed, Calendar, Plus, Trash2, CheckCircle } from "lucide-react";

//HELPER FUNCTIONS
// This function converts time string to minutes, managing AM/PM correctly
...
// This function converts YYYY-MM-DD to "Day Month Year" format
...
const AddPage = () => {
    ...
    function addSlotToForm() {
        ...
        //if date is of today the prevent from time 
        if (slotDate === today) {
            const now = new Date();
    ...
    async function handleAdd(e) {
        ...
        try {
            ...
            const API_BASE = "https://medicare-backend-jy3b.onrender.com/api";
    ...
    return (
        <div className={s.pageContainer}>
                ...
                <form onSubmit={handleAdd} className={s.formGrid}>
                    ...
                    <div className='relative'>
                        ...
                        <button type="button" onClick={() => setShowPassword((s) => !s)}
                            className={`${s.passwordToggleButton} cursor-pointer`}
                        >
            ...
            {/* Simple overview od added doctor*/}
            <div className={s.doctorListContainer}>
                {doctorList.length ? (
                    <div className={s.doctorListGrid}>
                        {doctorList.map((d) => (
                            <div key={d._id} className={s.doctorCard}>
