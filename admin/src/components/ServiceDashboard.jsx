...
import { ClipboardList, BadgeIndianRupee, CheckCircle, XCircle, Search, Calendar } from "lucide-react";
...
const ServiceDashboard = ({ services: servicesProp = null }) => {
    ...
    //fetch the services from the server side
    async function fetchServices({ showLoading = true } = {}) {
        ...
        try {
            ...
            const url = `${API_BASE}/api/service-appointment/stats/summary`;
                ...
                <div className={serviceDashboardStyles.search.container}>
                    <div className={serviceDashboardStyles.search.inputContainer}>
                        ...
                        <input type="text" placeholder="Search services..." value={searchQuery}
                            ...
                            className={serviceDashboardStyles.search.input}></input>
                                ...
                                <div key={s.id} className={serviceDashboardStyles.table.row}>
                                    ...
                                    <div className={serviceDashboardStyles.table.desktopView}>
                                        ...
                                        <div className={serviceDashboardStyles.table.desktopCenterCell(1)}>
                                            {formatCurrency(s.totalAppointments)}
                                        </div>
                                        <div className={serviceDashboardStyles.table.desktopCenterCell(1)}>
                                            {formatCurrency(s.completed)}
                                        </div>
                                        <div className={serviceDashboardStyles.table.desktopCenterCell(1)}>
                                            {formatCurrency(s.canceled)}
                                        </div>
