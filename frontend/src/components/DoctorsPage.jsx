...
import { Search, X, Medal, ChevronRight, MousePointer2Off
    ,CircleChevronUp, CircleChevronDown
 } from "lucide-react";
...
const DoctorsPage = () => {
    ...
    //load the doctors sre coming from server side
    useEffect(() => {
        let mounted = true;
        async function load() {
            setLoading(true);
                    ...
                    >
                        {displayedDoctors.length > 0 ? (
                            ...
                            <div className={doctorsPageStyles.noResults}>
                                No doctors found maching your search criteria.
                            </div>
                        )}
                    </div>
                )}
