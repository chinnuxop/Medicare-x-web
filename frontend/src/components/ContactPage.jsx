...
import { User, Mail, Phone, MapPin, Stethoscope, MessageSquare, SendHorizontal } from "lucide-react";
                    ...
                    <form onSubmit={handleSubmit} className={contactPageStyles.formSpace}>
                        ...
                        <div>
                            ...
                            <textarea name="message" value={form.message}
                                onChange={handleChange} placeholder="Describe your concern briefly..." className={contactPageStyles.textarea} />
                            {errors.message && (
                                <p className={contactPageStyles.error}>
                                    {errors.message}
                                </p>
                        ...
                        <div className={contactPageStyles.button}>
                ...
                <div className={contactPageStyles.infoContainer}>
                    <div className={contactPageStyles.infoCard}>
                        ...
                        <p className={contactPageStyles.infoItem}>
                            <Phone size={16} /> 8328967636
                        </p>
                        <p className={contactPageStyles.infoItem}>
                            <Mail size={16} /> info@medicaresolution.com
                        </p>
                    </div>
                    <iframe
                       src="https://www.google.com/maps?q=Centurion+University+Jatni+Bhubaneswar&output=embed"
                        className={contactPageStyles.map}
                        title="Centurion University, Jatni"
                        loading="lazy"
                        allowFullScreen
                    ></iframe>
